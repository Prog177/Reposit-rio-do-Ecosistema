...
def simular_populacoes (num_meses, param, t):
    ...
    for Iteration2 in range(t, int(num_meses) + int(t)):
        if Iteration2==0:
...
def simulador(nome_ficheiro):
    ...
    while True:
        ...
        if FuntionX[-2] == 's':
            if FuntionX[-1] == 'q':
                if t != 0:
                    nao_necessario, cenouras, coelhos, lobos, param, t = simular_populacoes(t-2, DicEco)
                    gravar_resultado_simulacao('resultados.csv', cenouras, coelhos, lobos)
                    print('Simulador Terminado.')
                    exit()
                if t == 0:
                    nao_necessario, cenouras, coelhos, lobos, param, t = simular_populacoes(0, DicEco)
                    gravar_resultado_simulacao('resultados.csv', cenouras, coelhos, lobos)
                    print('Simulador Terminado.')
                    exit()
            else:
        ...
        if FuntionX[-2] == 'd':
            ...
            if t != 0:
                nao_necessario, cenouras, coelhos, lobos, param, t = simular_populacoes(t-2, DicEco, t)
            if FuntionX[-1] == 'c':
